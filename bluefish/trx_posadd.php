...
?>
	...
	<form method="POST" action="<?php echo $__phpself; ?>?editing=<?php echo $_GET["editing"];?>&kode=<?php echo $_GET["kode"]; ?>">
		...
		<table width="100%"><tr><td align="center"><h3><b>BLUE FISH TOKO</b></h3></td></tr></table>
		<table>
			<tr>
				<td>Kode</td>
				<td>:</td>
	...
	<table width="100%">
		<tr>
			<td align="center">
				...
				<input type="button" value="Bayar With Room" onclick="document.getElementById('paylangsung').value=2;document.getElementById('modebutton').value='simpan';document.getElementById('formsubmit').click();">
