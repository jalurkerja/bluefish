		...
		<tr>
			<td>
				<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="white">
					<tr>
						<td width="150"><img src='images/logo.jpg' width='120' height='90'></td>
						<td width="150">&nbsp;</td>
						<td><h1><span style="font-family: Verdana;"><span style="color: rgb(51, 102, 255);">Enjoy your vacation<br>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; on the blue beach water </span></span></h1></td>
						<?php $___urlwebhosting="http://122.248.32.110/bluefish.co.id"; ?>
						<td align="right"><iframe scrolling="no" src="<?php echo $___urlwebhosting; ?>/slideimg1.php" width="227" height="100" frameborder="0" marginwidth="0" marginheight="0"></iframe></td>
					</tr>
				</table>
			</td>
		</tr>
